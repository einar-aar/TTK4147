...
// Tasks
static void task_led0(void* args){
...
static void task_led1(void* args){
...
int main(){
	...
	xTaskCreate(task_led0, "", 1024, NULL, tskIDLE_PRIORITY + 1, NULL);

    xTaskCreate(task_led1, "", 1024, NULL, tskIDLE_PRIORITY + 1, NULL);
